...
public class SnakeAndLadder3 extends JFrame implements ActionListener{
   PlayerCollection pc;
    ...
    public SnakeAndLadder3(PlayerCollection pc)  throws Throwable{
        ...
        btnPlay4 = new JButton(pc.getplayer(3).getname());
        ...
        btnPlay4.setBounds(580,400,80,30);
        add(btnPlay4);
        ...
        lblPlayerNo3.setBackground(Color.ORANGE);
        lblPlayerNo3.setForeground(Color.GREEN);
        add(lblPlayerNo3);
        
        lblPlayerNo4.setBounds(660,400,60,30);
        
        lblPlayerNo4.setOpaque(true);
        lblPlayerNo4.setBackground(Color.PINK);
        lblPlayerNo4.setForeground(Color.GREEN);
        add(lblPlayerNo4);
        
        newGame.setBounds(590, 450, 120, 30);
        add(newGame);
        ...
        lblPlayerPos3.setBackground(Color.ORANGE);
        background.add(lblPlayerPos3);
        
        coinPosition(4,playerCount4);
        lblPlayerPos4.setBounds(25, 515, w, h);
        lblPlayerPos4.setOpaque(true);
        lblPlayerPos4.setBackground(Color.PINK);
        background.add(lblPlayerPos4);
        ...
        btnPlay4.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if(play==0&& (e.getSource() == btnPlay1)) {
            ...
            if (play==3 && e.getSource() == btnPlay4) {
                  
            playerList4 = new StringBuffer();
            while(play==3)
            {
                 play = playDice(4);
            coinPosition(4,playerCount3);
            lblPlayerPos4.setBounds(x, y, w, h);
            repaint();
            for(int i=0;i<snl.Lsize();i++) {
                if (playerCount4 == snl.getLadder(i).getInitPos())
                {
                    playerCount4 = snl.getLadder(i).getFinalPos();
                    break;
                }
            }
            for(int i=0;i<snl.Ssize();i++) {
                if (playerCount4 == snl.getSnake(i).getInitPos())
                {
                    playerCount4 = snl.getSnake(i).getFinalPos();
                    break;
                }
            }
            coinPosition(4,playerCount4);
            ...
            if(playerCount4 == 100) {
                ...
                btnPlay2.setVisible(false);
                btnPlay1.setVisible(false);
                JOptionPane.showMessageDialog(this, pc.getplayer(3).getname()+" "+ "wins");
                dispose();
                        Exit ex = new Exit();
                        ex.setVisible(true);
    ...
    private int playDice(int player) {
        ...
        {
            playerList4.append(String.valueOf(diceResult));
            playerList4.append(",");
            lblPlayerNo4.setText(playerList3.toString());
            if(playerCount4+diceResult <= 100) {
                playerCount4 = playerCount4+diceResult;
                play = 0;
                if(diceResult == 6) {
                    play = 3;
                }
